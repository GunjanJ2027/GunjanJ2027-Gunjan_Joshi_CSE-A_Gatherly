        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Transforming your special moments into unforgettable experiences with our premium event planning services.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Absolute Cafe, Sohna,Gurugram, Haryana<br />HR 122103</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@gatherly.com" className="text-gray-400 hover:text-white transition-colors">
                  ankurgoyal407@gmail.com
                </a>
              </li>
            </ul>
          </div>
